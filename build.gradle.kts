...
kotlin {
    ...
    val xcf = XCFramework("AsyncStream")
    ...
    swiftExport {
        moduleName = "AsyncStream"
        flattenPackage = "io.github.kotlinmania.asyncstream"
    }

    android {
        namespace = "io.github.kotlinmania.asyncstream"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "async-stream-kotlin", version.toString())

    pom {
        name.set("async-stream-kotlin")
        description.set("Kotlin Multiplatform port of tokio-rs/async-stream - Asynchronous streams using async & await notation")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/async-stream-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/async-stream-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/async-stream-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/async-stream-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.asyncstream.codeql
