...
This file is the quick-reference operating contract for async-stream-kotlin. The longer
...
async-stream-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`async-stream`](https://crates.io/crates/async-stream). Upstream Rust is the behavioral oracle while the
